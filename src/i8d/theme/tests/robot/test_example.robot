...
#
#  $ bin/test -s i8d.theme -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src i8d.theme.testing.I8D_THEME_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot src/i8d/theme/tests/robot/test_example.robot
#
